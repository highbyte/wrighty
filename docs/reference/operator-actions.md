...
| Probe all enabled agents | **Direct:** the Agents menu starts one independently leased probe per enabled, detected agent | Not available | No combined command; probe agents individually with `wrighty provider probe` | [Web console](web-console.md) |
