...
---
This historical document contains the pre-overhaul flat schema. Current Wrighty rejects it with
`STORE_SCHEMA_UNSUPPORTED` and leaves it unchanged; no migration is attempted.
