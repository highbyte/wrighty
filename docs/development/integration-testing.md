...
`wrighty provider probe AGENT --yes --json` and the web console's **Agents** menu
can test capacity without claiming an item, regardless of whether a circuit is already
