    ...
    : IProviderCapacityProbeService
{
        ...
        await PostHandoverAsync(
            ...
            [
                new WorkerOperatorAction(
                    ...
                    "subscription usage and asks for confirmation.", Name: "probe-provider"),
                Actions.OperationalActionGuidance.RetryNow(detail.Id),
                Actions.OperationalActionGuidance.InspectRecovery(detail.Id)
            ],
            cancellationToken,
            projection,
            provider,
        ...
        CancellationToken cancellationToken)
    {
        ...
        await PostHandoverAsync(
            ...
            schedule.Workspace,
            [
                Actions.OperationalActionGuidance.HandoffNow(detail.Id),
                Actions.OperationalActionGuidance.InspectRecovery(detail.Id)
            ],
            cancellationToken,
            projection,
    ...
    internal static IReadOnlyList<WorkerOperatorAction> NeedsAttentionActions(
        ...
        Actions.OperationalActionGuidance.NeedsAttentionActions(id, agentName, surface, activeUntil, budget);
